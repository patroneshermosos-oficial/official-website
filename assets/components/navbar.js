        ...
        <div class="container-fluid px-3 px-xl-5">
              ...
              <li class="nav-item dropdown dropdown-menu-shadow-stacked">
                ...
                <ul class="dropdown-menu" aria-labelledby="categoryMenu">
                  ...
                  <li class="dropdown-submenu dropend">
                    ...
                    >
                    <div
                      class="dropdown-menu dropdown-menu-start dropdown-width-lg"
                      data-bs-popper="none"
                    >
                      <div class="row p-4">
                        ...
                        <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                          ...
                          <div class="d-flex mb-4 position-relative">
                            ...
                            <div class="ms-3">
                              <a class="stretched-link h6 mb-0" href="#"
                                >American Century University, New Mexico</a
                              >
                              <p class="mb-0 small">
                          ...
                          <div class="d-flex mb-4 position-relative">
                            ...
                            <div class="ms-3">
                              <a class="stretched-link h6 mb-0" href="#"
                                >Indiana College of - Bloomington</a
                              >
                              <p class="mb-0 small">
                          ...
                          <div class="d-flex position-relative">
                            ...
                            <div class="ms-3">
                              <a class="stretched-link h6 mb-0" href="#"
                                >University of South California</a
                              >
                              <p class="mb-0 small">
                        ...
                        <div class="col-xl-6 col-xxl-4">
                          ...
                          <div class="d-flex mb-4 position-relative">
                            <h2 class="mb-0">
                              <i
                                class="fab fa-fw fa-google text-google-icon"
                              ></i>
                            </h2>
                            <div class="ms-2">
                              <a class="stretched-link h6 mb-0" href="#"
                                >Google SEO certificate</a
                              >
                          ...
                          <div class="d-flex mb-4 position-relative">
                            <h2 class="mb-0">
                              <i
                                class="fab fa-fw fa-linkedin-in text-linkedin"
                              ></i>
                            </h2>
                            <div class="ms-2">
                              <a class="stretched-link h6 mb-0" href="#"
                                >Business Development Executive(BDE)</a
                              >
                              <p class="mb-0 small">No prerequisites</p>
                            </div>
                          </div>
                          ...
                          <div class="d-flex mb-4 position-relative">
                            <h2 class="mb-0">
                              <i
                                class="fab fa-fw fa-facebook text-facebook"
                              ></i>
                            </h2>
                            <div class="ms-2">
                              <a class="stretched-link h6 mb-0" href="#"
                                >Facebook social media marketing</a
                              >
                          ...
                          <div class="d-flex mb-4 position-relative">
                            <h2 class="mb-0">
                              <i
                                class="fas fa-fw fa-basketball-ball text-dribbble"
                              ></i>
                            </h2>
                            <div class="ms-2">
                              <a class="stretched-link h6 mb-0" href="#"
                                >Creative graphics design</a
                              >
                              <p class="mb-0 small">No prerequisites</p>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div
                            class="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden"
                            style="
            ...
            <ul class="navbar-nav navbar-nav-scroll me-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="demoMenu">
                  ...
                  <li>
                    <a class="dropdown-item" href="index-4.html">Home Course</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a class="dropdown-item" href="index-8.html">Home Tutor</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="index-9.html"
                      >Home School
                      <span class="badge bg-success ms-2 smaller">New</span></a
                    >
                  </li>
                  <li>
                  ...
                  <li><hr class="dropdown-divider" /></li>
                  <li>
                    <a class="dropdown-item" href="request-demo.html"
                      >Request a demo</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="book-class.html"
                      >Book a Class</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="request-access.html"
                      >Free Access</a
                    >
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                    ...
                    >
                      <li>
                        <a class="dropdown-item" href="course-categories.html"
                          >Course Categories
                          <span class="badge bg-success ms-2 smaller"
                            >New</span
                          ></a
                        >
                      </li>
                      ...
                      <li>
                        <a class="dropdown-item" href="course-grid.html"
                          >Course Grid Classic</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="course-grid-2.html"
                          >Course Grid Minimal</a
                        >
                      </li>
                      <li><hr class="dropdown-divider" /></li>
                      <li>
                        <a class="dropdown-item" href="course-list.html"
                          >Course List Classic</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="course-list-2.html"
                          >Course List Minimal</a
                        >
                      </li>
                      <li><hr class="dropdown-divider" /></li>
                      <li>
                        <a class="dropdown-item" href="course-detail.html"
                          >Course Detail Classic</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="course-detail-min.html"
                          >Course Detail Minimal</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="course-detail-adv.html"
                          >Course Detail Advance</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="course-video-player.html"
                          >Course Full Screen Video</a
                        >
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a class="dropdown-item" href="instructor-list.html"
                      >Instructor List</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="instructor-single.html"
                      >Instructor Single</a
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    <a class="dropdown-item" href="abroad-single.html"
                      >Abroad Single
                      <span class="badge bg-success ms-2 smaller">New</span></a
                    >
                  </li>
                  ...
                  <li class="dropdown-submenu dropend">
                    ...
                    >
                      ...
                      <li>
                        <a class="dropdown-item" href="shop-product-detail.html"
                          >Product detail</a
                        >
                      </li>
                    </ul>
                  ...
                  <li class="dropdown-submenu dropend">
                    ...
                    >
                      ...
                      <li>
                        <a class="dropdown-item" href="help-center-detail.html"
                          >Help Center Single</a
                        >
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a class="dropdown-item" href="empty-cart.html"
                      >Empty Cart</a
                    >
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                  ...
                  <li class="dropdown-submenu dropend">
                    <a class="dropdown-item dropdown-toggle" href="#"
                      ><i class="fas fa-user-tie fa-fw me-1"></i>Instructor</a
                    >
                    <ul
                      class="dropdown-menu dropdown-menu-start"
                      data-bs-popper="none"
                    >
                      <li>
                        <a
                          ...
                          ><i class="bi bi-grid-fill fa-fw me-1"></i
                          >Dashboard</a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><i class="bi bi-basket-fill fa-fw me-1"></i
                          >Courses</a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><i
                            class="bi bi-file-earmark-plus-fill fa-fw me-1"
                          ></i
                          >Create Course</a
                        >
                      </li>
                      ...
                      <li>
                        <a class="dropdown-item" href="instructor-quiz.html"
                          ><i class="bi bi-question-diamond fa-fw me-1"></i>Quiz
                          <span class="badge bg-success ms-2 smaller"
                            >New</span
                          ></a
                        >
                      ...
                      <li>
                        <a class="dropdown-item" href="instructor-order.html"
                          ><i class="bi bi-cart-check-fill fa-fw me-1"></i
                          >Orders</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="instructor-review.html"
                          ><i class="bi bi-star-fill fa-fw me-1"></i>Reviews</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="instructor-payout.html"
                          ><i class="fas fa-wallet fa-fw me-1"></i>Payout</a
                        >
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="dropdown-submenu dropend">
                    <a class="dropdown-item dropdown-toggle" href="#"
                      ><i class="fas fa-user-graduate fa-fw me-1"></i>Student</a
                    >
                    <ul
                      class="dropdown-menu dropdown-menu-start"
                      data-bs-popper="none"
                    >
                      ...
                      <li>
                        <a
                          ...
                          ><i class="bi bi-card-checklist fa-fw me-1"></i>My
                          Subscriptions</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="student-course-list.html"
                          ><i class="bi bi-basket-fill fa-fw me-1"></i
                          >Courses</a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><i class="far fa-fw fa-file-alt me-1"></i>Course
                          Resume
                          <span class="badge bg-success ms-2 smaller"
                            >New</span
                          ></a
                      ...
                      <li>
                        <a
                          ...
                          ><i
                            class="bi bi-credit-card-2-front-fill fa-fw me-1"
                          ></i
                          >Payment Info</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="student-bookmark.html"
                          ><i class="fas bi-cart-check-fill fa-fw me-1"></i
                          >Wishlist</a
                        >
                      </li>
                    </ul>
                  ...
                  <li>
                    <a class="dropdown-item" href="admin-dashboard.html"
                      ><i class="fas fa-user-cog fa-fw me-1"></i>Admin</a
                    >
                  </li>
                  <li><hr class="dropdown-divider" /></li>
                  <li>
                    <a class="dropdown-item" href="instructor-edit-profile.html"
                      ><i class="fas fa-fw fa-edit me-1"></i>Edit Profile</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="instructor-setting.html"
                      ><i class="fas fa-fw fa-cog me-1"></i>Settings</a
                    >
                  </li>
                  <li>
                    <a
              ...
              <li class="nav-item dropdown dropdown-fullwidth">
                ...
                >
                  <div class="row p-4 g-4">
                    ...
                    <div class="col-12">
                      <div
                        class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3"
                        role="alert"
                      >
                        <!-- Avatar -->
                        ...
                        click to <a href="#" class="alert-link">Join Now</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    ...
                    >
                      <i
                        class="text-warning fa-fw bi bi-life-preserver me-2"
                      ></i
                      >Support
                    </a>
                  </li>
          ...
          <div class="dropdown ms-1 ms-lg-0">
            ...
            >
              ...
              <li>
                <a class="dropdown-item" href="#"
                  ><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="#"
                  ><i class="bi bi-gear fa-fw me-2"></i>Account Settings</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="#"
                  ><i class="bi bi-info-circle fa-fw me-2"></i>Help</a
                >
              </li>
              <li>
